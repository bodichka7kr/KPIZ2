...
window.onload = function() {
    ...
    Element.prototype.unvis = function() {
    ...
    function removeEmployee() {
        var bool = confirm("Видалити дані?");
        if (bool) {
    ...
    function editEmployee() {
        ...
        getNode("title").innerText = "Редагувати";
    ...
    getNode("add").addEventListener("click", function() {
        getNode("overflow").vis();
        getNode("title").innerText = "Додати анкету";
    ...
    form.addEventListener("submit", function(event) {
        ...
        if (!((form.photo.files.length || edit.change) && els.name.value && els.post.value)) {
            alert("Вкажіть повні дані");
            return;
        }
